...
public class GATileEntities {
	public static SimpleMachineMetaTileEntity[] CLUSTERMILL = new SimpleMachineMetaTileEntity[14];
	...
	public static TileEntityFusionReactor[] FUSION_REACTOR = new TileEntityFusionReactor[4];
	...
	public static void init() {
		...
		if (GAConfig.GT5U.highTierClusterMills) {
			...
			CLUSTERMILL[8] = GregTechAPI.registerMetaTileEntity(2214, new SimpleMachineMetaTileEntity(location("cluster_mill.uhv"), GARecipeMaps.CLUSTER_MILL_RECIPES, Textures.WIREMILL_OVERLAY, 9));
			CLUSTERMILL[9] = GregTechAPI.registerMetaTileEntity(2215, new SimpleMachineMetaTileEntity(location("cluster_mill.uev"), GARecipeMaps.CLUSTER_MILL_RECIPES, Textures.WIREMILL_OVERLAY, 10));
			CLUSTERMILL[10] = GregTechAPI.registerMetaTileEntity(2216, new SimpleMachineMetaTileEntity(location("cluster_mill.uiv"), GARecipeMaps.CLUSTER_MILL_RECIPES, Textures.WIREMILL_OVERLAY, 11));
			CLUSTERMILL[11] = GregTechAPI.registerMetaTileEntity(2217, new SimpleMachineMetaTileEntity(location("cluster_mill.umv"), GARecipeMaps.CLUSTER_MILL_RECIPES, Textures.WIREMILL_OVERLAY, 12));
			CLUSTERMILL[12] = GregTechAPI.registerMetaTileEntity(2218, new SimpleMachineMetaTileEntity(location("cluster_mill.uxv"), GARecipeMaps.CLUSTER_MILL_RECIPES, Textures.WIREMILL_OVERLAY, 13));
			CLUSTERMILL[13] = GregTechAPI.registerMetaTileEntity(2219, new SimpleMachineMetaTileEntity(location("cluster_mill.opv"), GARecipeMaps.CLUSTER_MILL_RECIPES, Textures.WIREMILL_OVERLAY, 14));
		}
		...
		FUSION_REACTOR[3] = GregTechAPI.registerMetaTileEntity(2508, new TileEntityFusionReactor(location("fusion_reactor.uhv"), 9));
