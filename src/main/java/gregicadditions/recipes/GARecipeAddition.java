...
public class GARecipeAddition {
	...
	public static void init() {
		...
		//Machine Components
		removeCraftingRecipes(MetaItems.EMITTER_LV.getStackForm());
		removeCraftingRecipes(MetaItems.EMITTER_MV.getStackForm());
		removeCraftingRecipes(MetaItems.EMITTER_HV.getStackForm());
		removeCraftingRecipes(MetaItems.EMITTER_EV.getStackForm());
		removeCraftingRecipes(MetaItems.EMITTER_IV.getStackForm());

		removeCraftingRecipes(MetaItems.SENSOR_LV.getStackForm());
		removeCraftingRecipes(MetaItems.SENSOR_MV.getStackForm());
		removeCraftingRecipes(MetaItems.SENSOR_HV.getStackForm());
		removeCraftingRecipes(MetaItems.SENSOR_EV.getStackForm());
		removeCraftingRecipes(MetaItems.SENSOR_IV.getStackForm());

		removeCraftingRecipes(MetaItems.ROBOT_ARM_LV.getStackForm());
		removeCraftingRecipes(MetaItems.ROBOT_ARM_MV.getStackForm());
		removeCraftingRecipes(MetaItems.ROBOT_ARM_HV.getStackForm());
		removeCraftingRecipes(MetaItems.ROBOT_ARM_EV.getStackForm());
		removeCraftingRecipes(MetaItems.ROBOT_ARM_IV.getStackForm());

		removeCraftingRecipes(MetaItems.FIELD_GENERATOR_LV.getStackForm());
		removeCraftingRecipes(MetaItems.FIELD_GENERATOR_MV.getStackForm());
		removeCraftingRecipes(MetaItems.FIELD_GENERATOR_HV.getStackForm());
		removeCraftingRecipes(MetaItems.FIELD_GENERATOR_EV.getStackForm());
		removeCraftingRecipes(MetaItems.FIELD_GENERATOR_IV.getStackForm());
	...
	public static void init2() {
		...
		//Dust Uncrafting Fixes TODO this fails
		for (Material m : Material.MATERIAL_REGISTRY) {
			if (!OreDictUnifier.get(OrePrefix.dustSmall, m).isEmpty()) {
				removeRecipeByName(String.format("gregtech:small_dust_disassembling_%s", m.toString()));
				//removeCraftingRecipes(OreDictUnifier.get(OrePrefix.dustSmall, m));
				ModHandler.addShapedRecipe("dust_small_" + m.toString(), OreDictUnifier.get(OrePrefix.dustSmall, m, 4),
						" D", "  ", 'D',
						new UnificationEntry(OrePrefix.dust, m));
			}
		}
