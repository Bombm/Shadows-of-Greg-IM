...
//
		...
		//ssp
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Helium.getFluid(125),Materials.Chlorine.getFluid(125)).fluidOutputs(Materials.Argon.getPlasma(125)).duration(5).EUt(36000).EUToStart(30000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Uranium.getFluid(8),Materials.Germanium.getFluid(8)).fluidOutputs(Materials.Darmstadtium.getFluid(8)).duration(40).EUt(24000).EUToStart(20000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Oxygen.getFluid(250),Materials.Helium3.getFluid(250)).fluidOutputs(Materials.Neon.getPlasma(250)).duration(24).EUt(6144).EUToStart(80000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Stableisland.getFluid(512),GAMaterials.NEUTRONIUM.getFluid(1)).fluidOutputs(GAMaterials.NEUTRONIUM.getFluid(1)).duration(1).EUt(1000000000).EUToStart(1).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Cadmium.getFluid(16),Materials.Helium3.getFluid(1)).fluidOutputs(Materials.Tin.getPlasma(16)).duration(40).EUt(16000).EUToStart(170000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Germanium.getFluid(16),GAMaterials.NEUTRONIUM.getFluid(1)).fluidOutputs(Materials.Germanium.getPlasma(16)).duration(60).EUt(524288).EUToStart(400000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Copper.getFluid(16),GAMaterials.NEUTRONIUM.getFluid(1)).fluidOutputs(Materials.Copper.getPlasma(16)).duration(60).EUt(524288).EUToStart(400000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Californium.getFluid(16),Materials.Calcium.getFluid(64)).fluidOutputs(Materials.Oganesson_u.getPlasma(16)).duration(60).EUt(8388608).EUToStart(620000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Curium247.getFluid(16),Materials.Carbon.getFluid(16)).fluidOutputs(Materials.Nobelium.getPlasma(16)).duration(10).EUt(12400).EUToStart(200000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Neon.getFluid(16),Materials.Plutonium241.getFluid(16)).fluidOutputs(Materials.Rutherfordium.getPlasma(16)).duration(10).EUt(19300).EUToStart(360000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Californium.getFluid(16),Materials.Nitrogen.getFluid(16)).fluidOutputs(Materials.Dubnium.getPlasma(16)).duration(10).EUt(24700).EUToStart(420000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Californium.getFluid(125),Materials.Oxygen.getFluid(125)).fluidOutputs(Materials.Seaborgium.getPlasma(125)).duration(10).EUt(24700).EUToStart(420000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Bismuth.getFluid(16),Materials.Titanium.getFluid(16)).fluidOutputs(Materials.Bohrium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Bismuth.getFluid(16),Materials.Iron.getFluid(16)).fluidOutputs(Materials.Meitnerium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Bismuth.getFluid(16),Materials.Nickel.getFluid(16)).fluidOutputs(Materials.Roentgenium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Zinc.getFluid(16),Materials.Lead.getFluid(16)).fluidOutputs(Materials.Copernicium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Neptunium237.getFluid(16),Materials.Calcium.getFluid(16)).fluidOutputs(Materials.Hihonium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Plutonium.getFluid(16),Materials.Calcium.getFluid(16)).fluidOutputs(Materials.Flerovium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Americium.getFluid(16),Materials.Calcium.getFluid(16)).fluidOutputs(Materials.Moscovium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Curium247.getFluid(16),Materials.Calcium.getFluid(16)).fluidOutputs(Materials.Livermorium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Calcium.getFluid(16),Materials.Berklium.getFluid(16)).fluidOutputs(Materials.Tennessine.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
		RecipeMaps.FUSION_RECIPES.recipeBuilder().fluidInputs(Materials.Americium.getFluid(16),Materials.Helium.getFluid(16)).fluidOutputs(Materials.Berklium.getPlasma(16)).duration(10).EUt(16400).EUToStart(280000000).buildAndRegister();
